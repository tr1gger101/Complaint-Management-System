...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <br>
		            <input type="password" class="form-control" minlength="5" placeholder="Password" required="required" name="password"><br >
		             <input type="text" class="form-control" pattern="[7-9]{1}[0-9]{9}" name="contactno" placeholder="Contact no" required="required" autofocus>
		            <br>
