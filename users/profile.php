...
<div class="col-sm-4">
<input type="text" name="fullname" required="required" maxlength="25" value="<?php echo htmlentities($row['fullName']);?>" class="form-control" >
 </div>
...
<label class="col-sm-2 col-sm-2 control-label">Contact</label>
 <div class="col-sm-4">
<input type="text" name="contactno" required="required" pattern="[7-9]{1}[0-9]{9}" value="<?php echo htmlentities($row['contactNo']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label">Address </label>
<div class="col-sm-4">
<textarea  name="address" required="required" maxlength="100" class="form-control"><?php echo htmlentities($row['address']);?></textarea>
</div>
</div>
