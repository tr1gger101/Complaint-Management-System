...
if(isset($_GET['del']))
		  {
		          mysqli_query($bd, "delete from tblcomplaints where complaintNumber = '".$_GET['cid']."'");
                  header("Refresh:0; url=complaint-history.php");
		  }
else{
?>
<!DOCTYPE html>
...
<button type="button" class="btn btn-primary">View Details</button></a>
                                   ...
                                   <td align="center">
                                   <a href="complaint-history.php?cid=<?php echo htmlentities($row['complaintNumber']);?>&del=delete">
<button type="button" class="btn btn-theme04" onClick="return confirm('Are you sure you want to delete?')">Delete Complaint</button></a>
                                   </td>
                                </tr>
                              <?php } ?>
